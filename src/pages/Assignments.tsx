    ...
    <div>
      ...
      <div className="content-card">
          ...
          <tbody>
            {assignments.map((a, i) => (
              <tr key={i} className="border-b last:border-0">
                ...
                <td className="py-4 px-4 text-sm text-foreground">{a.cls}</td>
                ...
                <td className="py-4 px-4">
                  <div className="flex gap-2">
                    {a.actions.map((act) => (
                      <button key={act} className="text-sm text-primary font-medium hover:underline">{act}</button>
                    ))}
                  </div>
                </td>
              </tr>
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t">
          <p className="text-sm text-muted-foreground">Showing 5 of 24 assignments</p>
